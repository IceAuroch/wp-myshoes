...
class LiqPay
{
	...
	public function cnb_form($params)
	{
		...
		return sprintf('<form method="POST" action="%s" accept-charset="utf-8">%s%s
							<input id="sendliq" type="image" src="http://radikal.ru/Content/Images/Design/loading.gif" name="btn_text" />
 						</form>
 ',
			$this->_checkout_url,

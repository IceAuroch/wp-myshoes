...
<div class="row">
	...
	<div class="column medium-8 large-9">
		<form class="edit-account" action="" method="post">
			...
			<p class="form-row form-row-wide">
				<label for="account_phone"><?php _e( 'Phone', 'woocommerce' ); ?> <span class="required">*</span></label>
				<input type="tel" class="input-text" name="billing_phone" id="billing_phone" value="<?php echo esc_attr( $user->billing_phone ); ?>" />
			</p>

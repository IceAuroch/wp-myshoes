			...
			<form method="post" class="login">
				...
				<p>
					...
					<span class="lost_password">
						<a class="underline" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( 'Lost your password?', 'woocommerce' ); ?></a>
					</span>
				</p>
				...
				<p class="form-row">
					<button type="button" class="show-register button">Зарегистрироваться</button>
				</p>
	...
	<div class="col-2">		
		...
		<form method="post" class="register">
			...
			<div class="register-container">
				...
				<p class="form-row">
					<button type="button" class="show-register button">Авторизироваться</button>
				</p>
